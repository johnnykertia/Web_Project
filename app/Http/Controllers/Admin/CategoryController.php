...
use App\Http\Requests\AdminRequestUpdateCategory;
...
class CategoryController extends Controller
{
     ...
     */
    public function update(AdminRequestUpdateCategory $request, string $id)
    {
        $category = Category::findOrFail($id);
        $category->name = $request->name;
        $category->slug = \Str::slug($request->name);
    ...
    public function destroy(string $id)
    {
        try {
            ...
            return response(['status' => 'error', 'message' => __('Something Wrong')]);
        }
    }
}
