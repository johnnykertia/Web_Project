            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    ...
                    @else
                        <div class="card my-5">
                            <div class="card-boy">
                                <h5 class="p-1 text-center">Please <a href="{{ route('login') }}">Login</a> to Comments here</h5>
                            </div>
                        </div>
                    @endauth
                                    ...
                                    @if ($loop->index === 3)
                                        ...
                                        <div class="article__entry">
                                            ...
                                            <div class="article__content">
                                                ...
                                                <a href="{{ route('news-details', $news->slug) }}"
                                                    class="btn btn-outline-primary p-1 mb-6 text-capitalize">
                                                    {{ __('read more') }}</a>
                                            </div>
                                        </div>
                                    @endif
